...
exports.creds = {
    ...
    redirectUrl: 'https://toolagen-timesheet-server.azurewebsites.net/auth/openid/return', 
  ...
  exports.destroySessionUrl = 'https://login.microsoftonline.com/common/oauth2/logout?post_logout_redirect_uri=https://toolagen-timesheet-server.azurewebsites.net';
  ...
  exports.clientUrl = "https://toolagen-timesheet-ui.azurewebsites.net"; //http://localhost:4200, https://tg-ui-timesheet.azurewebsites.net